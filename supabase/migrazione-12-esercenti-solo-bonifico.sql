-- MIGRAZIONE 12 — esercenti e rivenditori pagano SOLO con bonifico (niente carta, niente contrassegno)
...
begin
  ...
  if prof.ruolo = 'admin' then raise exception 'L''account del titolare non fa ordini: usa un account cliente'; end if;
  ...
  if pro and p_metodo <> 'bonifico' then raise exception 'Esercenti e rivenditori pagano solo con bonifico bancario'; end if;
